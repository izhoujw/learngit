...
此时有两种选择：
* 删除 git rm test.txt     git commit -m 'remove test.txt' (手动删除，再add change to stage, 效果和git rm 是一样的)
...
* 首先在GitHub创建一个新的仓库，gitskills，勾选创建readme.md.
